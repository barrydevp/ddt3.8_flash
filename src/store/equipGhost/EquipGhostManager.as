package store.equipGhost
{
   ...
   public class EquipGhostManager extends EventDispatcher
   {
	  ...
	  public static var MAX_STAR_LEVEL:uint = 10;
      ...
      private function calulateRatio() : void
      {
         ...
         {
            _loc1_ = (_loc4_ = PlayerManager.Instance.Self.getGhostDataByCategoryID(_equip.CategoryID)) == null ? 0 : _loc4_.level;
      ...
      public function getPorpertyData(param1:InventoryItemInfo, param2:PlayerInfo = null) : GhostPropertyData
      {
         ...
         if(_loc8_)
         {
            ...
            if(_loc14_)
            {
               ...
               _loc12_ = uint(_loc3_.Attack * _loc14_.attackAdd / 1000);
               _loc9_ = uint(_loc3_.Luck * _loc14_.luckAdd / 1000);
               _loc13_ = uint(_loc3_.Defence * _loc14_.defendAdd / 1000);
               _loc7_ = uint(_loc3_.Agility * _loc14_.agilityAdd / 1000);
            }
      ...
      public function getPropertyDataByLv(param1:InventoryItemInfo, param2:int) : GhostPropertyData
      {
         ...
         var _loc4_:uint = 0;
         var _loc9_:uint = parseInt(param1.Property7);
         var _loc14_:* = 0;
         if(param1.CategoryID == 7)
         {
         ...
         {
            _loc3_ = ItemManager.Instance.getTemplateById(param1.TemplateID);
            _loc11_ = _loc3_.Attack * _loc13_.attackAdd / 1000;
            _loc8_ = _loc3_.Luck * _loc13_.luckAdd / 1000;
            _loc12_ = _loc3_.Defence * _loc13_.defendAdd / 1000;
            _loc7_ = _loc3_.Agility * _loc13_.agilityAdd / 1000;
         }
      ...
      private function __syncEquipGhost(param1:PkgEvent) : void
      {
         ...
         while(_loc5_ < _loc7_)
         {
            ...
            (_loc6_ = new EquipGhostData(_loc2_,_loc4_)).level = _loc3_.readInt();
            _loc6_.totalGhost = _loc3_.readInt();
            PlayerManager.Instance.Self.addGhostData(_loc6_);
            _loc5_++;
         }
         dispatchEvent(new CEvent("equip_ghost_data"));
      }
   }
}
