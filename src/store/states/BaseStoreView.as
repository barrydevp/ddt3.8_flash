package store.states
{
	...
	public class BaseStoreView extends Sprite implements Disposeable
	{
		...
		private function init() : void
		{
			...
			this._forgeview.storeBagController = this._storeBag;
...
//			this._storeBag.getBagView().visible = false; // 12/08/2022
		...
		private function __cellDoubleClick(param1:CellEvent) : void
		{
			...
			else if(this._storeBag.currentPanel == StoreMainView.EQUIPGHOST) {
				_loc2_ = this._forgeview.fineGhostView;
			}
			else
			{
