package store.view.strength
{
   ...
   public class LaterEquipmentView extends Component
   {
	  ...
	  private function getGhostPropertyData() : GhostPropertyData
	  {
		  ...
		  var _ghostPropertyData:GhostPropertyData = _loc5_ == null || _loc5_.Place > 30 || !EquipGhostManager.getInstance().isEquipGhosting() ? null : EquipGhostManager.getInstance().getPorpertyData(_loc5_,PlayerInfoViewControl.currentPlayer);
		  var _loc77_:GoodTipInfo = _tipData as GoodTipInfo;
		  if(_loc77_)
		  {
			  if(_loc77_.ghostLv > 0 && (_loc5_ != null && _loc5_.Place <= 30) && EquipGhostManager.getInstance().isEquipGhosting())
			  {
				  _ghostPropertyData = EquipGhostManager.getInstance().getPropertyDataByLv(_loc5_,_loc77_.ghostLv);
			  }
		  }
		  return _ghostPropertyData;
	  }
      ...
      private function createProperties() : void
      {
		 ...
		 if(this._info.Attack != 0)
		 {
			 ...
			 UIUtils.setTextFieldColor(this._attackTxt, GoodTip.ITEM_PROPERTIES_COLOR, 0, base1.length);
			 UIUtils.setTextFieldColor(this._attackTxt, GoodTip.YELLOW_TEXT_COLOR, base1.length, this._attackTxt.text.length);
		 ...
		 if(this._info.Defence != 0)
		 {
			 ...
			 UIUtils.setTextFieldColor(this._defenseTxt, GoodTip.ITEM_PROPERTIES_COLOR, 0, base2.length);
			 UIUtils.setTextFieldColor(this._defenseTxt, GoodTip.YELLOW_TEXT_COLOR, base2.length, this._defenseTxt.text.length);
			 _loc6_ = this._displayIdx++;
		 ...
		 if(this._info.Agility != 0)
		 {
			 ...
			 UIUtils.setTextFieldColor(this._agilityTxt, GoodTip.ITEM_PROPERTIES_COLOR, 0, base3.length);
			 UIUtils.setTextFieldColor(this._agilityTxt, GoodTip.YELLOW_TEXT_COLOR, base3.length, this._agilityTxt.text.length);
			 _loc6_ = this._displayIdx++;
		 ...
		 if(this._info.Luck != 0)
		 {
			 ...
			 UIUtils.setTextFieldColor(this._luckTxt, GoodTip.ITEM_PROPERTIES_COLOR, 0, base4.length);
			 UIUtils.setTextFieldColor(this._luckTxt, GoodTip.YELLOW_TEXT_COLOR, base4.length, this._luckTxt.text.length);
			 _loc6_ = this._displayIdx++;
	  ...
	  private function createGhostItemStar(): void {
		  ...
		  var tipData:GoodTipInfo = _tipData as GoodTipInfo;
		  if(this._ghostPropertyData && tipData && tipData.ghostLv > 0){
			  var _curLevel:uint = tipData.ghostLv;
