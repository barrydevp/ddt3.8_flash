package store.view.storeBag
{
	...
	public class StoreBagController
	{
		...
		{
			var currentPanel:int = param1.currentPanel;
//			if(param1.currentPanel == StoreMainView.WISHBEAD && ForgeMainView.ISFRIST)
			if(currentPanel == StoreMainView.WISHBEAD || currentPanel == StoreMainView.LatentEnergy || currentPanel == StoreMainView.GemStone)
			{
