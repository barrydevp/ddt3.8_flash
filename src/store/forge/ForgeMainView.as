package store.forge
{
   ...
   import store.forge.fineGhost.FineGhostView;
   ...
   public class ForgeMainView extends Sprite implements Disposeable
   {
	  ...
	  private var _fineGhostView:FineGhostView;
      ...
      public function ForgeMainView(param1:int = 0)
      {
		 ...
		 UIModuleLoader.Instance.addUIModuleImp(UIModuleTypes.EQUIP_GHOST);
      }
      
      private function onUimoduleLoadProgress(param1:UIModuleEvent) : void
      {
         if(param1.module == UIModuleTypes.FORGE_MAIN || param1.module == UIModuleTypes.EQUIP_GHOST)
         {
	  ...
	  public function set storeBagController(param1:StoreBagController) : void
	  {
      ...
      public function changeHandler(param1:Event) : void
      {
		 ...
		 if(this._fineGhostView)
		 {
			 this._fineGhostView.visible = false;
		 }
         switch(this._tabSBG.selectIndex)
         {
			...
			case 4:
				if(!this._fineGhostView)
				{
					this._fineGhostView = new FineGhostView(this._controller);
					PositionUtils.setPos(this._wishBeadView,"forgeMainView.wishBeadViewPos");
					addChild(this._fineGhostView);
				}
				this._fineGhostView.visible = true;
				this._rightBgView.showStoreBagViewText("forgeMainView.wishBead.equipTipTxt","forgeMainView.wishBead.itemTipTxt");
				this._rightBgView.visible = true;
				this.bg.setFrame(1);
				this.currentPanelIndex = StoreMainView.EQUIPGHOST;
				break;
         }
      }
      ...
      override public function set visible(param1:Boolean) : void
      {
         ...
         if(visible)
         {
			...
			if(this._fineGhostView)
			{
//				this._fineGhostView.clearCellInfo();
//				this._fineGhostView.refreshListData();
			}
         }
      }
	  ...
	  public function get fineGhostView() : FineGhostView
	  {
		  return this._fineGhostView;
	  }
   }
}
