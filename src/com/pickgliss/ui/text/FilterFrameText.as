package com.pickgliss.ui.text
{
   ...
   public class FilterFrameText extends TextField implements Disposeable
   {
	  ...
	  public function setTextColor(color:uint, begin:int, end:int = -1): void {
		  ...
		  var txtFormat:TextFormat = this.getTextFormat(begin, end);
		  txtFormat.color = color;
		  this.setTextFormat(txtFormat, begin, end);
