package trainer.view
{
   ...
   public class NewHandContainer
   {
      ...
      public function showArrow(param1:int, param2:int, param3:String, param4:String = "", param5:String = "", param6:DisplayObjectContainer = null, param7:int = 0, param8:Boolean = false) : void
      {
