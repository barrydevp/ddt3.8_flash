package ddt.data
{
   ...
   public class EquipType
   {
	  ...
	  public static const GHOST_LUCK:int = 11185;
	  public static const GHOST_STONE1:int = 11186;
	  ...
	  public static function isWeapon(param1:ItemTemplateInfo) : Boolean
	  {
		  return param1.CategoryID == 7;
	  }
